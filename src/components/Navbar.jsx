    ...
    <nav className='bg-neutral-900/95 sticky top-0 z-50'>
      <div className="container mx-auto p-3 flex items-center justify-between">
        ...
        <div className="flex gap-3 text-md">
          ...
          <a target='_blank' rel="noreferrer" href="https://strapi-production-f5fc.up.railway.app/admin" className='text-neutral-300 hover:text-white flex gap-2 items-center'>Dodaj
